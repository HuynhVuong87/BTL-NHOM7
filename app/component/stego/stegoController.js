app.controller("stegoController", function ($scope) {
    ...
    function handleImage(e) {
        ...
        reader.onload = function (event) {
            ...
            $scope.linkImage = event.target.result;
            $scope.$apply()
            console.log($scope.linkImage);
            ...
            img.onload = function () {
                ...
                var messageText = (messageInput.value.length) ? messageInput.value : 'No thing in my eye =)))';
                ...
                new Noty({
                    ...
                    theme: 'relax',
                    type: 'success',
                    text: 'Bây giờ bạn có thể tải hình ảnh vừa được giấu tin vào và có thể gửi cho bạn bè'
                  }).show()
            };
